...
export default function App() {
  ...
  const runAggregation = (nextSeed = seed, count = iterations) => {
    ...
    const moduleDef = buildModule(anchorOffset, anchorDiag, anchorRot, anchorDiagB, anchorRotB);
    ...
    const sX = Math.max(0.6, Number.isFinite(spacingX) ? spacingX : 2.1);
    const sY = Math.max(0.6, Number.isFinite(spacingY) ? spacingY : 1.05);
